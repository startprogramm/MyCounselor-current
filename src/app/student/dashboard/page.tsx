              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className="border-[#EF4444] bg-[#EF4444] text-white hover:bg-[#DC2626]"
                  >
                    Reject
                  </Button>
                </div>
              ...
              <Card key={c.id} className="p-0 overflow-hidden h-full border-border" hover>
                ...
                <div className="relative p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Link
                      href="/student/messages"
                      className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg border border-[#16A34A] bg-[#16A34A] text-sm font-medium text-white hover:bg-[#15803D] transition-colors"
                    >
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-2 text-xs">
                        ...
                        <span className="px-2.5 py-1 rounded-full border border-[#F97316] bg-[#F97316] text-white capitalize">
                          {request.category}
                        </span>
                      </div>
                    </div>
