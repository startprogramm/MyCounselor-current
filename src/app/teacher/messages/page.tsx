  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Communicate with counselors and parents</p>
      </div>
      ...
      <Card className="p-8 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-2 max-w-md mx-auto">
          Teacher messaging is being set up. You&apos;ll be able to communicate directly with counselors and parents here.
        </p>
      </Card>
    </div>
  );
